...
for (const codeBlock of codeBlocks) {
    ...
    lang.innerText = codeBlock.getAttribute("data-lang");
    lang.classList.add("code-lang");
    infoBox.append(lang);

    if (codeBlock.hasAttribute("data-name")) {
        const file = document.createElement("p");
        file.innerText = codeBlock.getAttribute("data-name");
        file.classList.add("code-file");
        infoBox.append(file);
    }
